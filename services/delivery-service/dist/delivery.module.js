...
exports.DeliveryModule = DeliveryModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([delivery_entity_1.Delivery])],
        controllers: [delivery_controller_1.DeliveryController],
        providers: [delivery_service_1.DeliveryService, delivery_gateway_1.DeliveryGateway],
        exports: [delivery_service_1.DeliveryService, delivery_gateway_1.DeliveryGateway],
    })
], DeliveryModule);
